            ...
            <div className="lg:col-span-7 space-y-8 relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                <Button
                  size="lg"
                  asChild
                  className="overflow-hidden bg-primary text-primary-foreground px-8 py-6 text-lg font-medium transition-all duration-300 hover:shadow-lg hover:shadow-primary/50 active:scale-95"
                >
